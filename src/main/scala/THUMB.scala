...
object THUMB {
  ...
  val Format5: Regex = "^010001([01]{2})([01]{2})([01]{3})([01]{3})$".r
  val Format6: Regex = "^01001([01]{3})([01]{8})$".r
  val Format7: Regex = "^0101([01]{2})0([01]{3})([01]{3})([01]{3})$".r
  val Format8: Regex = "^0101([01]{2})1([01]{3})([01]{3})([01]{3})$".r
  val Format9: Regex = "^011([01]{2})([01]{5})([01]{3})([01]{3})$".r
